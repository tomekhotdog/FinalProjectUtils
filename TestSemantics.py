...
# BABA semantics testing (with random variables)
    ...
    def test_compute_semantic_probabilities(self):
        ...
        self.assertEqual(g, [('_a', '0.360'), ('_b', '0.400'), ('_c', '0.000'), ('a', '0.640'),
                             ('b', '0.600'), ('c', '1.000'), ('j', '0.640'), ('s', '0.600'), ('t', '0.400')])
        self.assertEqual(s, [('_a', '0.360'), ('_b', '0.400'), ('_c', '0.000'), ('a', '0.640'),
                             ('b', '0.600'), ('c', '1.000'), ('j', '0.640'), ('s', '0.600'), ('t', '0.400')])
        self.assertEqual(i, [('_a', '0.360'), ('_b', '0.400'), ('_c', '0.000'), ('a', '0.640'),
                             ('b', '0.600'), ('c', '1.000'), ('j', '0.640'), ('s', '0.600'), ('t', '0.400')])
